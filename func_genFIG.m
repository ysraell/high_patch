function [z1_,z2_,x_] = func_genFIG(fig_file,rblur,N1,N2,tau,patch_Rand,show_image)
    ...
    z1 = imresize(imresize(x_,round(res./(2^rblur)),'bicubic'),res,'bicubic');
    ...
    % Randomly choose the first pixel of the patch extracted from x to obtain z2.
    if patch_Rand
        lr = randi(l-res(1));
        cr = randi(c-res(2));
    else
